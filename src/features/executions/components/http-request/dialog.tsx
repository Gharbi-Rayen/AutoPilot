...
export const HttpRequestDialog = ({ open, onOpenChange
    , onSubmit , defaultEndpoint = "", defaultMethod = "GET", defaultBody = ""
    ...
    const watchMethode = form.watch("method");
    const showBodyField = ["POST", "PUT", "PATCH", "DELETE"].includes(watchMethode);
                                    ...
                                    <FormLabel>Endpoint URL</FormLabel>
                                      ...
                                      <FormControl>
                                        ...
                                        <FormDescription>
                                           ...
                                           simple values or use {"{{json variable}}"} to stringify objects.
                                         </FormDescription>
