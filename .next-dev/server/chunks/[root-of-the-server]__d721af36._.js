...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$middleware$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@inngest/realtime/middleware.mjs [app-route] (ecmascript) <locals>");
...
const inngest = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$Inngest$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Inngest"]({
    id: "autopilot",
    middleware: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$middleware$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["realtimeMiddleware"])()
    ]
});
}),
"[project]/src/inngest/channels/google-form-trigger.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@inngest/realtime/index.mjs [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$channel$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@inngest/realtime/channel.mjs [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$topic$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@inngest/realtime/topic.mjs [app-route] (ecmascript)");
;
const GOOGLE_FORM_TRIGGER_CHANNEL_NAME = "google-form-trigger-execution";
const GoogleFormTriggerChannel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$channel$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["channel"])(GOOGLE_FORM_TRIGGER_CHANNEL_NAME).addTopic((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$topic$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["topic"])("status").type());
}),
"[project]/src/features/triggers/components/googleForm-trigger/executor.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$google$2d$form$2d$trigger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/inngest/channels/google-form-trigger.ts [app-route] (ecmascript)");
;
const GoogleFormExecutor = async ({ nodeId, context, step, publish })=>{
    const updateStatePublish = async (state)=>{
        console.log("[GoogleFormExecutor] Publishing status:", {
            nodeId,
            state
        });
        const result = await publish((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$google$2d$form$2d$trigger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["GoogleFormTriggerChannel"])().status({
            nodeId,
            status: state
        }));
    ...
    try {
        ...
        console.error("[GoogleFormExecutor] Error:", {
            nodeId,
            error
        });
...
"[project]/src/inngest/channels/manual-triggers.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ManualTriggerChannel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$channel$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["channel"])(MANUAL_TRIGGER_CHANNEL_NAME).addTopic((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$topic$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["topic"])("status").type());
}),
"[project]/src/features/triggers/components/manual-trigger/executor.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$manual$2d$triggers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/inngest/channels/manual-triggers.ts [app-route] (ecmascript)");
;
const manualTriggerExecutor = async ({ nodeId, context, step, publish })=>{
    const updateStatePublish = async (state)=>{
        ...
        const result = await publish((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$manual$2d$triggers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ManualTriggerChannel"])().status({
            nodeId,
            status: state
        }));
    ...
    try {
        ...
        console.error("[ManualTriggerExecutor] Error:", {
            nodeId,
            error
        });
        await updateStatePublish("error");
...
"[project]/src/inngest/channels/stripe-trigger.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const StripeTriggerChannel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$channel$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["channel"])(STRIPE_TRIGGER_CHANNEL_NAME).addTopic((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$topic$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["topic"])("status").type());
}),
"[project]/src/features/triggers/components/stripe-trigger/executor.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$stripe$2d$trigger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/inngest/channels/stripe-trigger.ts [app-route] (ecmascript)");
;
const StripeExecutor = async ({ nodeId, context, step, publish })=>{
    const updateStatePublish = async (state)=>{
        const result = await publish((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$stripe$2d$trigger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["StripeTriggerChannel"])().status({
            nodeId,
            status: state
        }));
        return result;
    ...
    try {
        const result = await step.run("stripe-trigger", async ()=>{
            ...
            if (context.stripeData) {
                const stripe = context.stripeData;
                ...
                console.log("  - To access raw fields, use: {{stripeData.raw.fieldName}}");
            }
            return context;
        });
        ...
        console.error("[StripeExecutor] Error:", {
            nodeId,
            error
        });
        await updateStatePublish("error");
 ...
 */ const config = {
    "generator": {
        ...
        "output": {
            "value": "C:\\Users\\gghar\\OneDrive\\Bureau\\AutoPilot\\autopilot\\src\\generated\\prisma",
            "fromEnvVar": null
        },
        "config": {
            "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "C:\\Users\\gghar\\OneDrive\\Bureau\\AutoPilot\\autopilot\\prisma\\schema.prisma",
        "isCustomOutput": true
    },
    "relativeEnvPaths": {
        "rootEnvPath": null,
    ...
    "inlineSchemaHash": "ccb9639de43cad8cd1de390e9932b3b1505bdb8b82877f2c2891b2ff1bbc4cb9",
    "copyEngine": true
};
...
"[project]/src/inngest/channels/anthropic.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const AnthropicChannel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$channel$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["channel"])(ANTHROPIC_CHANNEL_NAME).addTopic((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$topic$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["topic"])("status").type());
}),
...
const prisma = globalForPrisma.prisma || new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$client$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PrismaClient"]({
    adapter: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$prisma$2f$adapter$2d$neon$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PrismaNeon"]({
        connectionString
    })
});
if ("TURBOPACK compile-time truthy", 1) {
...
"[project]/src/features/executions/components/anthropic/executor.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/handlebars/lib/index.js [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$anthropic$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/inngest/channels/anthropic.ts [app-route] (ecmascript)");
...
;
;
__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].registerHelper("json", (context)=>{
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].SafeString(JSON.stringify(context, null, 2));
});
const AnthropicExecutor = async ({ data, nodeId, context, step, publish, userId })=>{
    const updateStatePublish = async (state)=>{
        return await publish((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$anthropic$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AnthropicChannel"])().status({
            nodeId,
            status: state
        }));
    };
    ...
    if (!data.variableName) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Variable name is required");
    }
    if (!data.userPrompt) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("User prompt is required");
    }
    if (!data.credentialId) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Anthropic API key is required. Please configure an API key in the node settings.");
    }
    const credential = await step.run("fetch-anthropic-credential", async ()=>{
        const cred = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].credentials.findUnique({
            where: {
        ...
        if (!cred) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("API key not found or access denied. It may have been deleted.");
        }
        return cred;
    });
    const systemPrompt = data.systemPrompt ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compile(data.systemPrompt)(context) : "You are a helpful assistant.";
    const userPrompt = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compile(data.userPrompt)(context);
    ...
    try {
        const { text } = await step.ai.wrap("anthropic-generate-text", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["generateText"], {
        ...
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](`Failed to generate text: ${error}`);
    }
};
}),
"[project]/src/inngest/channels/code.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const CodeChannel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$channel$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["channel"])(CODE_CHANNEL_NAME).addTopic((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$topic$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["topic"])("status").type());
}),
"[project]/src/features/executions/components/code/executor.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/inngest/components/NonRetriableError.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$code$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/inngest/channels/code.ts [app-route] (ecmascript)");
;
;
;
;
...
function execCommand(cmd, args, options) {
    return new Promise((resolve, reject)=>{
        (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$child_process__$5b$external$5d$__$28$node$3a$child_process$2c$__cjs$29$__["execFile"])(cmd, args, options, (error, stdout, stderr)=>{
            if (error) {
...
async function executeJavaCode(code, contextJson) {
    // Extract the class name from the code (look for "public class <Name>")
    const classNameMatch = code.match(/public\s+class\s+(\w+)/);
    const className = classNameMatch?.[1] ?? "Main";
    const workDir = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["join"])((0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$os__$5b$external$5d$__$28$node$3a$os$2c$__cjs$29$__["tmpdir"])(), `autopilot-java-${Date.now()}`);
    const sourceFile = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["join"])(workDir, `${className}.java`);
    try {
        await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs$2f$promises__$5b$external$5d$__$28$node$3a$fs$2f$promises$2c$__cjs$29$__["mkdir"])(workDir, {
            recursive: true
        });
        await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs$2f$promises__$5b$external$5d$__$28$node$3a$fs$2f$promises$2c$__cjs$29$__["writeFile"])(sourceFile, code, "utf-8");
        // Compile
...
async function executeJavaScriptCode(code, context) {
    const fn = new AsyncFunction("context", code);
    const executionResult = await Promise.race([
        fn(context),
        new Promise((_, reject)=>setTimeout(()=>reject(new Error(`Code execution timed out after ${CODE_TIMEOUT_MS / 1000} seconds`)), CODE_TIMEOUT_MS))
    ]);
    return executionResult ?? null;
}
const CodeExecutor = async ({ data, nodeId, context, step, publish })=>{
    const updateStatePublish = async (state)=>{
        return await publish((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$code$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CodeChannel"])().status({
            nodeId,
            status: state
        }));
    };
    ...
    if (!data.code) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Code is required");
    }
    const language = data.language ?? "javascript";
    try {
        const result = await step.run("code-execute", async ()=>{
            if (language === "java") {
                return executeJavaCode(data.code, JSON.stringify(context));
            }
            return executeJavaScriptCode(data.code, context);
        });
        await updateStatePublish("success");
        return {
            ...context,
        ...
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](`Code execution failed: ${errorMessage}`);
    }
};
}),
"[project]/src/inngest/channels/discord.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const DiscordChannel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$channel$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["channel"])(DISCORD_CHANNEL_NAME).addTopic((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$topic$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["topic"])("status").type());
}),
"[project]/src/features/executions/components/discord/executor.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$discord$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/inngest/channels/discord.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/db.ts [app-route] (ecmascript)");
;
;
;
...
const DiscordExecutor = async ({ data, nodeId, context, step, publish, userId })=>{
    const updateStatePublish = async (state)=>{
        return await publish((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$discord$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DiscordChannel"])().status({
            nodeId,
            status: state
        }));
    };
    ...
    if (!data.content) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Message content is required");
    }
    if (!data.credentialId) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Discord Webhook URL is required. Please configure a webhook credential in the node settings.");
    }
    const credential = await step.run("fetch-discord-credential", async ()=>{
        ...
        if (!cred) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Webhook credential not found or access denied. It may have been deleted.");
        }
        return cred;
    });
    const webhookUrl = credential.value;
    let messageContent = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compile(data.content)(context);
    ...
    try {
        const result = await step.run("discord-send-message", async ()=>{
            ...
            if (data.username) {
                payload.username = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compile(data.username)(context);
            }
            if (data.avatarUrl) {
                payload.avatar_url = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compile(data.avatarUrl)(context);
            }
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ky$2f$distribution$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].post(webhookUrl, {
                json: payload,
                searchParams: {
                    wait: "true"
                }
        ...
        await updateStatePublish("error");
        const errorMessage = error instanceof Error ? error.message : String(error);
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](`Failed to send Discord message: ${errorMessage}`);
    }
};
}),
"[project]/src/inngest/channels/file.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const FileChannel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$channel$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["channel"])(FILE_CHANNEL_NAME).addTopic((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$topic$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["topic"])("status").type());
}),
"[project]/src/features/executions/components/download-file/executor.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/inngest/components/NonRetriableError.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/handlebars/lib/index.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$file$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/inngest/channels/file.ts [app-route] (ecmascript)");
;
;
;
const DownloadFileExecutor = async ({ data, nodeId, context, step, publish })=>{
    const updateStatePublish = async (state)=>{
        return await publish((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$file$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FileChannel"])().status({
            nodeId,
            status: state
        }));
    };
    ...
    if (!data.fileUrl) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("File URL is required");
    }
    const fileUrl = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compile(data.fileUrl)(context);
    const fileName = data.fileName || "downloaded-file";
    try {
        const fileData = await step.run("download-file", async ()=>{
            const response = await fetch(fileUrl);
            if (!response.ok) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](`Failed to download file: ${response.statusText}`);
            }
        ...
        await updateStatePublish("error");
        throw error instanceof Error ? new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](error.message) : new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Failed to download file");
    }
};
}),
...
"[project]/src/inngest/channels/email.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const EmailChannel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$channel$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["channel"])(EMAIL_CHANNEL_NAME).addTopic((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$topic$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["topic"])("status").type());
}),
"[project]/src/features/executions/components/email/executor.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/inngest/channels/email.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/db.ts [app-route] (ecmascript)");
;
;
;
...
const EmailExecutor = async ({ data, nodeId, context, step, publish, userId })=>{
    const updateStatePublish = async (state)=>{
        return await publish((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EmailChannel"])().status({
            nodeId,
            status: state
        }));
    };
    ...
    if (!data.fromEmail) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("From email address is required");
    }
    if (!data.toEmail) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("To email address is required");
    }
    if (!data.subject) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Email subject is required");
    }
    if (!data.body) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Email body is required");
    }
    if (!data.credentialId) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("SMTP password/app password is required. Please configure an email credential in the node settings.");
    }
    const credential = await step.run("fetch-email-credential", async ()=>{
        ...
        if (!cred) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Email credential not found or access denied. It may have been deleted.");
        }
        return cred;
    });
    const toEmail = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compile(data.toEmail)(context);
    const subject = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compile(data.subject)(context);
    const body = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compile(data.body)(context);
    try {
        const result = await step.run("email-send", async ()=>{
            ...
            const transporter = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nodemailer$2f$lib$2f$nodemailer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].createTransport(transportConfig);
            const mailOptions = {
                from: data.fromEmail,
                to: toEmail,
                subject
        ...
        await updateStatePublish("error");
        const errorMessage = error instanceof Error ? error.message : String(error);
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](`Failed to send email: ${errorMessage}`);
    }
};
}),
"[project]/src/inngest/channels/gemini.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const GeminiChannel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$channel$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["channel"])(GEMINI_CHANNEL_NAME).addTopic((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$topic$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["topic"])("status").type());
}),
"[project]/src/features/executions/components/gemini/executor.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/handlebars/lib/index.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/inngest/components/NonRetriableError.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$gemini$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/inngest/channels/gemini.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/db.ts [app-route] (ecmascript)");
;
;
;
...
const GeminiExecutor = async ({ data, nodeId, context, step, publish, userId })=>{
    const updateStatePublish = async (state)=>{
        return await publish((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$gemini$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["GeminiChannel"])().status({
            nodeId,
            status: state
        }));
    };
    ...
    if (!data.credentialId) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Gemini API key is required. Please configure an API key in the node settings.");
    }
    ...
    try {
        const { text } = await step.ai.wrap("gemini-generate-text", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["generateText"], {
...
"[project]/src/inngest/channels/http-request.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const HttpRequestChannel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$channel$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["channel"])(HTTP_REQUEST_CHANNEL_NAME).addTopic((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$topic$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["topic"])("status").type());
}),
"[project]/src/features/executions/components/http-request/executor.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/inngest/components/NonRetriableError.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ky$2f$distribution$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/ky/distribution/index.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$http$2d$request$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/inngest/channels/http-request.ts [app-route] (ecmascript)");
;
;
;
;
__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].registerHelper("json", (context)=>{
    ...
    const safeString = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].SafeString(jsonString);
    return safeString;
});
const HttpRequestExecutor = async ({ data, nodeId, context, step, publish })=>{
    //publish "loading" state for http request node
    const updateStatePublish = async (state)=>{
        const result = await publish((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$http$2d$request$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["HttpRequestChannel"])().status({
            nodeId,
            status: state
        }));
        return result;
    ...
    try {
        const result = await step.run("http-request", async ()=>{
            ...
            if (!data.endpoint) {
                ...
                await updateStatePublish("error");
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("HTTP Request node is not configured with an endpoint");
            }
            if (!data.variableName) {
                // publish "error" state for http request node
                await updateStatePublish("error");
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("HTTP Request node is not configured with a variable name");
            }
            if (!data.method) {
                // publish "error" state for http request node
                await updateStatePublish("error");
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("HTTP Request node is not configured with a method");
            }
            //compile endpoint and body with handlebars
            const endpoint = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compile(data.endpoint)(context);
            ...
            if (!endpoint || endpoint.trim() === "") {
                ...
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](`Endpoint URL is empty after variable interpolation. ` + `Template: "${data.endpoint}". ` + `Available context keys: ${Object.keys(context).join(", ")}. ` + `Check that your variable names match exactly (case-sensitive).`);
            }
            ...
            if ([
                ...
                const resolvedBody = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compile(data.body || "{}")(context);
            ...
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ky$2f$distribution$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(endpoint, options);
...
"[project]/src/inngest/channels/openai.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const OpenAIChannel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$channel$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["channel"])(OPENAI_CHANNEL_NAME).addTopic((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$topic$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["topic"])("status").type());
}),
"[project]/src/features/executions/components/openai/executor.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/handlebars/lib/index.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/inngest/components/NonRetriableError.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$openai$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/inngest/channels/openai.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/db.ts [app-route] (ecmascript)");
;
;
;
...
const OpenAIExecutor = async ({ data, nodeId, context, step, publish, userId })=>{
    const updateStatePublish = async (state)=>{
        return await publish((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$openai$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["OpenAIChannel"])().status({
            nodeId,
            status: state
        }));
    };
    ...
    if (!data.credentialId) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("OpenAI API key is required. Please configure an API key in the node settings.");
    }
    ...
    const systemPrompt = data.systemPrompt ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compile(data.systemPrompt)(context) : "You are a helpful assistant.";
    const userPrompt = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compile(data.userPrompt)(context);
    const openai = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$openai$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createOpenAI"])({
        apiKey: credential.value
    });
    try {
        const { text } = await step.ai.wrap("openai-generate-text", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["generateText"], {
...
"[project]/src/inngest/channels/slack.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SlackChannel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$channel$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["channel"])(SLACK_CHANNEL_NAME).addTopic((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$topic$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["topic"])("status").type());
}),
"[project]/src/features/executions/components/slack/executor.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/inngest/components/NonRetriableError.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ky$2f$distribution$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/ky/distribution/index.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$slack$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/inngest/channels/slack.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/db.ts [app-route] (ecmascript)");
;
;
;
...
const SlackExecutor = async ({ data, nodeId, context, step, publish, userId })=>{
    const updateStatePublish = async (state)=>{
        return await publish((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$slack$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SlackChannel"])().status({
            nodeId,
            status: state
        }));
    };
    ...
    if (!data.text) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Message text is required");
    }
    if (!data.credentialId) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Slack Webhook URL is required. Please configure a webhook credential in the node settings.");
    }
    ...
    const webhookUrl = credential.value;
    let messageText = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compile(data.text)(context);
    ...
    try {
        ...
        await updateStatePublish("error");
        const errorMessage = error instanceof Error ? error.message : String(error);
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](`Failed to send Slack message: ${errorMessage}`);
    }
};
}),
"[project]/src/inngest/channels/telegram.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const TelegramChannel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$channel$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["channel"])(TELEGRAM_CHANNEL_NAME).addTopic((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$topic$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["topic"])("status").type());
}),
"[project]/src/features/executions/components/telegram/executor.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/inngest/components/NonRetriableError.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ky$2f$distribution$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/ky/distribution/index.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$telegram$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/inngest/channels/telegram.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/db.ts [app-route] (ecmascript)");
;
;
;
...
const TelegramExecutor = async ({ data, nodeId, context, step, publish, userId })=>{
    const updateStatePublish = async (state)=>{
        return await publish((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$telegram$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TelegramChannel"])().status({
            nodeId,
            status: state
        }));
    };
    ...
    if (!data.chatId) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Chat ID is required");
    }
    if (!data.text) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Message text is required");
    ...
    if (!data.credentialId) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Telegram Bot Token is required. Please configure a bot token credential in the node settings.");
    }
    const credential = await step.run("fetch-telegram-credential", async ()=>{
        ...
        if (!cred) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Bot token credential not found or access denied. It may have been deleted.");
        }
        return cred;
    });
    const botToken = credential.value;
    const chatId = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compile(data.chatId)(context);
    let messageText = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compile(data.text)(context);
    ...
    try {
        const result = await step.run("telegram-send-message", async ()=>{
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ky$2f$distribution$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].post(`${TELEGRAM_API_BASE}${botToken}/sendMessage`, {
                json: payload
            }).json();
            const timestamp = new Date().toISOString();
        ...
        await updateStatePublish("error");
        const errorMessage = error instanceof Error ? error.message : String(error);
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](`Failed to send Telegram message: ${errorMessage}`);
    }
};
}),
"[project]/src/inngest/channels/whatsapp.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const WhatsAppChannel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$channel$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["channel"])(WHATSAPP_CHANNEL_NAME).addTopic((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$realtime$2f$topic$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["topic"])("status").type());
}),
"[project]/src/features/executions/components/whatsapp/executor.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/inngest/components/NonRetriableError.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ky$2f$distribution$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/ky/distribution/index.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$whatsapp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/inngest/channels/whatsapp.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/db.ts [app-route] (ecmascript)");
;
;
;
...
const WhatsAppExecutor = async ({ data, nodeId, context, step, publish, userId })=>{
    const updateStatePublish = async (state)=>{
        return await publish((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$whatsapp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["WhatsAppChannel"])().status({
            nodeId,
            status: state
        }));
    };
    ...
    if (!data.phoneNumberId) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Phone Number ID is required");
    }
    if (!data.recipientPhone) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Recipient phone number is required");
    }
    if (!data.text) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Message text is required");
    ...
    if (!data.credentialId) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("WhatsApp Access Token is required. Please configure a token credential in the node settings.");
    }
    const credential = await step.run("fetch-whatsapp-credential", async ()=>{
        ...
        if (!cred) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Access token credential not found or access denied. It may have been deleted.");
        }
        return cred;
    });
    const accessToken = credential.value;
    const recipientPhone = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compile(data.recipientPhone)(context);
    let messageText = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$handlebars$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compile(data.text)(context);
    ...
    try {
        const result = await step.run("whatsapp-send-message", async ()=>{
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ky$2f$distribution$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].post(`${WHATSAPP_API_BASE}/${data.phoneNumberId}/messages`, {
                json: payload,
                headers: {
        ...
        await updateStatePublish("error");
        const errorMessage = error instanceof Error ? error.message : String(error);
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](`Failed to send WhatsApp message: ${errorMessage}`);
    }
};
}),
"[project]/src/features/executions/components/upload-file/executor.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const UploadFileExecutor = async ({ data, nodeId, context, step, publish })=>{
    const updateStatePublish = async (state)=>{
        return await publish((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$file$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FileChannel"])().status({
            nodeId,
            status: state
    ...
    try {
        const fileData = await step.run("process-uploaded-file", async ()=>{
            ...
            const uploadedFile = context["_uploadedFile"];
            if (!uploadedFile) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("No file uploaded. Please select a file in the Upload File node.");
            }
            // Validate file size if specified
            if (data.maxSizeMB && uploadedFile.size) {
                const maxBytes = data.maxSizeMB * 1024 * 1024;
                if (uploadedFile.size > maxBytes) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](`File size exceeds maximum allowed (${data.maxSizeMB}MB)`);
                }
            }
            // Validate file type if specified
            if (data.allowedTypes && data.allowedTypes.length > 0 && uploadedFile.mimeType) {
                ...
                if (!isAllowed) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](`File type not allowed. Accepted types: ${data.allowedTypes.join(", ")}`);
                }
            }
            return {
        ...
        await updateStatePublish("error");
        throw error instanceof Error ? new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](error.message) : new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Failed to process uploaded file");
    }
};
}),
"[project]/src/features/executions/components/read-file/executor.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const ReadFileExecutor = async ({ data, nodeId, context, step, publish })=>{
    const updateStatePublish = async (state)=>{
        return await publish((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$file$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FileChannel"])().status({
            nodeId,
            status: state
    ...
    if (!data.fileVariable) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Source file variable is required");
    }
    const encoding = data.encoding || "utf-8";
    try {
        const fileData = await step.run("read-file", async ()=>{
            const fileObj = context[data.fileVariable];
            if (!fileObj) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](`File variable '${data.fileVariable}' not found in workflow context`);
            }
            const file = fileObj;
            if (!file.buffer && !file.url) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("File object must have a buffer or URL");
            }
            let content;
            if (file.buffer) {
                content = Buffer.isBuffer(file.buffer) ? file.buffer.toString(encoding) : file.buffer;
            } else if (file.url) {
                const response = await fetch(file.url);
                if (!response.ok) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](`Failed to fetch file from URL: ${response.statusText}`);
                }
                content = await response.text();
            } else {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Cannot read file: no buffer or URL");
            }
            return {
                content,
                fileName: file.name,
        ...
        await updateStatePublish("error");
        throw error instanceof Error ? new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](error.message) : new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Failed to read file");
    }
};
}),
"[project]/src/features/executions/components/pdf-extract-text/executor.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const PdfExtractTextExecutor = async ({ data, nodeId, context, step, publish })=>{
    const updateStatePublish = async (state)=>{
        return await publish((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$file$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FileChannel"])().status({
            nodeId,
            status: state
    ...
    if (!data.pdfVariable) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Source PDF variable is required");
    }
    try {
        const extractedData = await step.run("extract-pdf-text", async ()=>{
            const pdfObj = context[data.pdfVariable];
            if (!pdfObj) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](`PDF variable '${data.pdfVariable}' not found in workflow context`);
            }
            const pdf = pdfObj;
            if (!pdf.buffer && !pdf.url) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("PDF object must have a buffer or URL");
            }
            let buffer;
            if (pdf.buffer) {
                buffer = Buffer.isBuffer(pdf.buffer) ? pdf.buffer : Buffer.from(pdf.buffer);
            } else if (pdf.url) {
                const response = await fetch(pdf.url);
                if (!response.ok) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](`Failed to fetch PDF from URL: ${response.statusText}`);
                }
                buffer = Buffer.from(await response.arrayBuffer());
            } else {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Cannot extract text: no buffer or URL");
            }
            const { CanvasFactory } = await __turbopack_context__.A("[externals]/pdf-parse/worker [external] (pdf-parse/worker, esm_import, async loader)");
            const { PDFParse } = await __turbopack_context__.A("[externals]/pdf-parse [external] (pdf-parse, esm_import, async loader)");
        ...
        await updateStatePublish("error");
        throw error instanceof Error ? new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](error.message) : new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Failed to extract PDF text");
    }
};
}),
"[project]/src/features/executions/components/csv-parse/executor.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const CsvParseExecutor = async ({ data, nodeId, context, step, publish })=>{
    const updateStatePublish = async (state)=>{
        return await publish((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$file$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FileChannel"])().status({
            nodeId,
            status: state
    ...
    if (!data.csvVariable) {
        await updateStatePublish("error");
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Source CSV variable is required");
    }
    const hasHeader = data.hasHeader ?? true;
    const delimiter = data.delimiter || ",";
    try {
        const parsedData = await step.run("parse-csv", async ()=>{
            const csvObj = context[data.csvVariable];
            if (!csvObj) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](`CSV variable '${data.csvVariable}' not found in workflow context`);
            }
            const csv = csvObj;
            if (!csv.buffer && !csv.url && typeof csv !== "string") {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("CSV object must have a buffer, URL, or be a string");
            }
            let csvText;
            if (typeof csv === "string") {
                csvText = csv;
            } else if (csv.buffer) {
                csvText = Buffer.isBuffer(csv.buffer) ? csv.buffer.toString("utf-8") : csv.buffer;
            } else if (csv.url) {
                const response = await fetch(csv.url);
                if (!response.ok) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](`Failed to fetch CSV from URL: ${response.statusText}`);
                }
                csvText = await response.text();
            } else if (csv.content) {
                csvText = csv.content;
            } else {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Cannot parse CSV: no content found");
            }
            const records = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$csv$2d$parse$2f$lib$2f$sync$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["parse"])(csvText, {
                columns: hasHeader,
                delimiter,
                trim: true,
        ...
        await updateStatePublish("error");
        throw error instanceof Error ? new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](error.message) : new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Failed to parse CSV");
    }
};
}),
"[project]/src/features/executions/components/stubs/executors.ts [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/inngest/components/NonRetriableError.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$file$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/inngest/channels/file.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$read$2d$file$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/executions/components/read-file/executor.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$pdf$2d$extract$2d$text$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/executions/components/pdf-extract-text/executor.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$csv$2d$parse$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/executions/components/csv-parse/executor.ts [app-route] (ecmascript)");
;
;
;
;
;
const pendingExecutor = (name)=>{
    return async ({ data })=>{
...
const resolveRecords = (value)=>{
    ...
    if (typeof value === "object" && value !== null && "records" in value && Array.isArray(value.records)) {
        return value.records.filter((item)=>typeof item === "object" && item !== null);
    }
    return [];
};
...
const applyCsvPredicate = (row, field, operator, expectedValue)=>{
    const rawValue = row[field];
    if (operator === "is_empty") {
        return rawValue === undefined || rawValue === null || typeof rawValue === "string" && rawValue.trim() === "";
    }
...
const csvEscape = (value, delimiter)=>{
    ...
    const mustQuote = text.includes("\n") || text.includes("\r") || text.includes('"') || text.includes(delimiter);
    if (!mustQuote) {
        return text;
    }
    return `"${text.replaceAll('"', '""')}"`;
};
const withFileNodeStatus = async (nodeId, publish, task)=>{
    const publishStatus = async (status)=>publish((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$file$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FileChannel"])().status({
            nodeId,
            status
        }));
...
;
;
const writeFileExecutor = async ({ data, nodeId, context, publish, step })=>withFileNodeStatus(nodeId, publish, async ()=>{
        if (!data.variableName) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Variable name is required");
        }
        if (!data.sourceVariable) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Source variable is required");
        }
        const source = context[data.sourceVariable];
        if (source === undefined) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](`Source variable '${data.sourceVariable}' not found in workflow context`);
        }
        const file = await step.run("write-file", async ()=>{
            ...
            if (Buffer.isBuffer(source)) {
                buffer = source;
            } else if (typeof source === "object" && source !== null && "buffer" in source && Buffer.isBuffer(source.buffer)) {
...
const pdfSplitExecutor = pendingExecutor("pdf_split");
const pdfMergeExecutor = pendingExecutor("pdf_merge");
const pdfFillFormExecutor = pendingExecutor("pdf_fill_form");
const pdfGenerateExecutor = pendingExecutor("pdf_generate");
const pdfSignExecutor = pendingExecutor("pdf_sign");
const convertFileExecutor = async ({ data, nodeId, context, publish, step })=>withFileNodeStatus(nodeId, publish, async ()=>{
        if (!data.variableName) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Variable name is required");
        }
        if (!data.sourceVariable) {
...
const pdfExtractTablesExecutor = pendingExecutor("pdf_extract_tables");
const csvGenerateExecutor = async ({ data, nodeId, context, publish, step })=>withFileNodeStatus(nodeId, publish, async ()=>{
        if (!data.variableName) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Variable name is required");
        }
        if (!data.sourceVariable) {
        ...
        const output = await step.run("csv-generate", async ()=>{
            ...
            if (rows.length === 0) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Source data must be an array of records");
            }
...
const csvFilterExecutor = async ({ data, nodeId, context, publish, step })=>withFileNodeStatus(nodeId, publish, async ()=>{
        if (!data.variableName) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Variable name is required");
        }
        if (!data.sourceVariable) {
        ...
        if (!data.field) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Field is required");
        }
        const source = context[data.sourceVariable];
        const rows = resolveRecords(source);
        if (rows.length === 0) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Source variable must contain CSV records");
        }
        const operator = data.operator ?? "eq";
        const filtered = await step.run("csv-filter", async ()=>{
            const result = rows.filter((row)=>applyCsvPredicate(row, data.field, operator, data.value));
            return {
                records: result,
...
const csvAggregateExecutor = async ({ data, nodeId, context, publish, step })=>withFileNodeStatus(nodeId, publish, async ()=>{
        if (!data.variableName) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Variable name is required");
        }
        if (!data.sourceVariable) {
        ...
        if (!data.groupBy) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Group by field is required");
        }
        const source = context[data.sourceVariable];
        const rows = resolveRecords(source);
        if (rows.length === 0) {
        ...
        const aggregated = await step.run("csv-aggregate", async ()=>{
            ...
            const records = Array.from(groups.entries()).map(([groupKey, groupRows])=>{
                ...
                if (!data.targetField) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("targetField is required for sum/avg/min/max operations");
                }
                const numbers = groupRows.map((row)=>parseNumber(row[data.targetField])).filter((n)=>n !== null);
                if (numbers.length === 0) {
                    base.value = null;
                    return base;
                }
...
const csvJoinExecutor = async ({ data, nodeId, context, publish, step })=>withFileNodeStatus(nodeId, publish, async ()=>{
        if (!data.variableName) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Variable name is required");
        }
        if (!data.leftVariable || !data.rightVariable) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Both left and right source variables are required");
        }
        if (!data.leftKey || !data.rightKey) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Both leftKey and rightKey are required");
        }
        const leftRows = resolveRecords(context[data.leftVariable]);
        const rightRows = resolveRecords(context[data.rightVariable]);
        if (leftRows.length === 0 || rightRows.length === 0) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Both source variables must contain CSV records");
        }
...
const readExcelExecutor = pendingExecutor("read_excel");
const writeExcelExecutor = pendingExecutor("write_excel");
const appendRowExecutor = pendingExecutor("append_row");
const sheetTransformExecutor = pendingExecutor("sheet_transform");
const createPresentationExecutor = pendingExecutor("create_presentation");
const addSlideExecutor = pendingExecutor("add_slide");
const fillTemplateExecutor = pendingExecutor("fill_template");
const resizeImageExecutor = pendingExecutor("resize_image");
const cropImageExecutor = pendingExecutor("crop_image");
const convertImageExecutor = pendingExecutor("convert_image");
const ocrImageExecutor = pendingExecutor("ocr_image");
const jsonTransformExecutor = pendingExecutor("json_transform");
const filterExecutor = async ({ data, nodeId, context, publish, step })=>withFileNodeStatus(nodeId, publish, async ()=>{
        if (!data.variableName) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Variable name is required");
        }
        if (!data.sourceVariable) {
        ...
        const rows = resolveRecords(source);
        if (rows.length === 0) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Source variable must contain records");
        }
        const operator = data.operator ?? "eq";
        const filtered = await step.run("filter-data", async ()=>{
            const records = rows.filter((row)=>applyCsvPredicate(row, data.field, operator, data.value));
            return {
                records,
                rowCount: records.length
            };
...
const loopExecutor = pendingExecutor("loop");
const conditionExecutor = pendingExecutor("condition");
const delayExecutor = pendingExecutor("delay");
const mergeExecutor = async ({ data, nodeId, context, publish, step })=>withFileNodeStatus(nodeId, publish, async ()=>{
        if (!data.variableName) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Variable name is required");
        }
        if (!data.leftVariable || !data.rightVariable) {
        ...
        const output = await step.run("merge-data", async ()=>{
            ...
            if (!data.leftKey || !data.rightKey) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("leftKey and rightKey are required when strategy is by_key");
            }
            ...
            if (leftRecords.length === 0 || rightRecords.length === 0) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Both source variables must contain records when strategy is by_key");
            }
            const rightIndex = new Map();
...
const splitExecutor = async ({ data, nodeId, context, publish, step })=>withFileNodeStatus(nodeId, publish, async ()=>{
        if (!data.sourceVariable) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Source variable is required");
        }
        ...
        if (!Number.isFinite(chunkSize) || chunkSize < 1) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("chunkSize must be a number greater than 0");
        }
        const source = context[data.sourceVariable];
        const list = resolveList(source);
        if (list.length === 0) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("Source variable must contain an array or records list");
        }
...
const s3UploadExecutor = pendingExecutor("s3_upload");
const s3DownloadExecutor = pendingExecutor("s3_download");
const googleDriveExecutor = pendingExecutor("google_drive");
const dropboxExecutor = pendingExecutor("dropbox");
const localStorageExecutor = pendingExecutor("local_storage");
}),
"[project]/src/features/executions/components/read-file/executor.ts [app-route] (ecmascript) <export ReadFileExecutor as readFileExecutor>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "readFileExecutor",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$read$2d$file$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ReadFileExecutor"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$read$2d$file$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/executions/components/read-file/executor.ts [app-route] (ecmascript)");
}),
"[project]/src/features/executions/components/pdf-extract-text/executor.ts [app-route] (ecmascript) <export PdfExtractTextExecutor as pdfExtractTextExecutor>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "pdfExtractTextExecutor",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$pdf$2d$extract$2d$text$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PdfExtractTextExecutor"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$pdf$2d$extract$2d$text$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/executions/components/pdf-extract-text/executor.ts [app-route] (ecmascript)");
}),
"[project]/src/features/executions/components/csv-parse/executor.ts [app-route] (ecmascript) <export CsvParseExecutor as csvParseExecutor>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "csvParseExecutor",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$csv$2d$parse$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CsvParseExecutor"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$csv$2d$parse$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/executions/components/csv-parse/executor.ts [app-route] (ecmascript)");
}),
"[project]/src/features/executions/components/lib/executor-registry.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$triggers$2f$components$2f$googleForm$2d$trigger$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/triggers/components/googleForm-trigger/executor.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$triggers$2f$components$2f$manual$2d$trigger$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/triggers/components/manual-trigger/executor.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$triggers$2f$components$2f$stripe$2d$trigger$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/triggers/components/stripe-trigger/executor.ts [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$anthropic$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/executions/components/anthropic/executor.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$code$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/executions/components/code/executor.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$discord$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/executions/components/discord/executor.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$download$2d$file$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/executions/components/download-file/executor.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$email$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/executions/components/email/executor.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$gemini$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/executions/components/gemini/executor.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$http$2d$request$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/executions/components/http-request/executor.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$openai$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/executions/components/openai/executor.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$slack$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/executions/components/slack/executor.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$telegram$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/executions/components/telegram/executor.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$whatsapp$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/executions/components/whatsapp/executor.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$upload$2d$file$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/executions/components/upload-file/executor.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/features/executions/components/stubs/executors.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$read$2d$file$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__ReadFileExecutor__as__readFileExecutor$3e$__ = __turbopack_context__.i("[project]/src/features/executions/components/read-file/executor.ts [app-route] (ecmascript) <export ReadFileExecutor as readFileExecutor>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$pdf$2d$extract$2d$text$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__PdfExtractTextExecutor__as__pdfExtractTextExecutor$3e$__ = __turbopack_context__.i("[project]/src/features/executions/components/pdf-extract-text/executor.ts [app-route] (ecmascript) <export PdfExtractTextExecutor as pdfExtractTextExecutor>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$csv$2d$parse$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__CsvParseExecutor__as__csvParseExecutor$3e$__ = __turbopack_context__.i("[project]/src/features/executions/components/csv-parse/executor.ts [app-route] (ecmascript) <export CsvParseExecutor as csvParseExecutor>");
;
;
;
;
...
const executorRegistry = {
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].MANUAL_TRIGGER]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$triggers$2f$components$2f$manual$2d$trigger$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["manualTriggerExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].HTTP_REQUEST]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$http$2d$request$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["HttpRequestExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].INITIAL]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$triggers$2f$components$2f$manual$2d$trigger$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["manualTriggerExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].GOOGLE_FORM_TRIGGER]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$triggers$2f$components$2f$googleForm$2d$trigger$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["GoogleFormExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].STRIPE_TRIGGER]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$triggers$2f$components$2f$stripe$2d$trigger$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["StripeExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].GEMINI]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$gemini$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["GeminiExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].OPENAI]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$openai$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["OpenAIExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].ANTHROPIC]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$anthropic$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AnthropicExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].DISCORD]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$discord$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DiscordExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].SLACK]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$slack$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SlackExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].TELEGRAM]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$telegram$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TelegramExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].EMAIL_SMTP]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$email$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EmailExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].WHATSAPP]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$whatsapp$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["WhatsAppExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].CODE]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$code$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CodeExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].DOWNLOAD_FILE]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$download$2d$file$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DownloadFileExecutor"],
    // File Processing Nodes
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].UPLOAD_FILE]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$upload$2d$file$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UploadFileExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].READ_FILE]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$read$2d$file$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__ReadFileExecutor__as__readFileExecutor$3e$__["readFileExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].WRITE_FILE]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["writeFileExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].CONVERT_FILE]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["convertFileExecutor"],
    // PDF Processing Nodes
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].PDF_EXTRACT_TEXT]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$pdf$2d$extract$2d$text$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__PdfExtractTextExecutor__as__pdfExtractTextExecutor$3e$__["pdfExtractTextExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].PDF_EXTRACT_TABLES]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["pdfExtractTablesExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].PDF_SPLIT]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["pdfSplitExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].PDF_MERGE]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["pdfMergeExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].PDF_FILL_FORM]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["pdfFillFormExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].PDF_GENERATE]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["pdfGenerateExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].PDF_SIGN]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["pdfSignExecutor"],
    // CSV Processing Nodes
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].CSV_PARSE]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$csv$2d$parse$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__CsvParseExecutor__as__csvParseExecutor$3e$__["csvParseExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].CSV_GENERATE]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["csvGenerateExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].CSV_FILTER]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["csvFilterExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].CSV_AGGREGATE]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["csvAggregateExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].CSV_JOIN]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["csvJoinExecutor"],
    // Spreadsheet Nodes
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].READ_EXCEL]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["readExcelExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].WRITE_EXCEL]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["writeExcelExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].APPEND_ROW]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["appendRowExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].SHEET_TRANSFORM]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["sheetTransformExecutor"],
    // PowerPoint Nodes
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].CREATE_PRESENTATION]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createPresentationExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].ADD_SLIDE]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["addSlideExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].FILL_TEMPLATE]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["fillTemplateExecutor"],
    // Image Processing Nodes
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].RESIZE_IMAGE]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["resizeImageExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].CROP_IMAGE]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["cropImageExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].CONVERT_IMAGE]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["convertImageExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].OCR_IMAGE]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ocrImageExecutor"],
    // Data Transformation Nodes
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].JSON_TRANSFORM]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["jsonTransformExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].FILTER]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["filterExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].LOOP]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["loopExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].CONDITION]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["conditionExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].DELAY]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["delayExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].MERGE]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["mergeExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].SPLIT]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["splitExecutor"],
    // Storage Nodes
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].S3_UPLOAD]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["s3UploadExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].S3_DOWNLOAD]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["s3DownloadExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].GOOGLE_DRIVE]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["googleDriveExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].DROPBOX]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["dropboxExecutor"],
    [__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NodeType"].LOCAL_STORAGE]: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$stubs$2f$executors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["localStorageExecutor"]
};
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$toposort$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/toposort/index.js [app-route] (ecmascript)");
...
const topologicalSort = (nodes, connections)=>{
    ...
    let sortedNodeIds;
    try {
        sortedNodeIds = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$toposort$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(edges);
        //remove duplicates from self edges
        sortedNodeIds = [
            ...new Set(sortedNodeIds)
        ];
    } catch (error) {
...
const sendWorkflowExecution = async (data)=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["inngest"].send({
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/inngest/components/NonRetriableError.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$lib$2f$executor$2d$registry$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/executions/components/lib/executor-registry.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/db.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$anthropic$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/inngest/channels/anthropic.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$code$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/inngest/channels/code.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$discord$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/inngest/channels/discord.ts [app-route] (ecmascript)");
...
;
;
const executeWorkflow = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["inngest"].createFunction({
    id: "execute/workflow",
    retries: 0
}, {
    event: "workflows/execute.workflow",
    channels: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$http$2d$request$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["HttpRequestChannel"])(),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$manual$2d$triggers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ManualTriggerChannel"])(),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$google$2d$form$2d$trigger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["GoogleFormTriggerChannel"])(),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$stripe$2d$trigger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["StripeTriggerChannel"])(),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$gemini$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["GeminiChannel"])(),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$openai$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["OpenAIChannel"])(),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$anthropic$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AnthropicChannel"])(),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$discord$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DiscordChannel"])(),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$slack$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SlackChannel"])(),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$telegram$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TelegramChannel"])(),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EmailChannel"])(),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$whatsapp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["WhatsAppChannel"])(),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$channels$2f$code$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CodeChannel"])()
    ]
    ...
    if (!workflowId) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"]("No workflow ID provided");
    }
    const workflowData = await step.run("prepare-workflow", async ()=>{
        console.log("[Inngest] Fetching workflow:", workflowId);
        const workflow = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].workflow.findUnique({
            where: {
                id: workflowId
            },
            include: {
        ...
        if (!workflow) {
            ...
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$NonRetriableError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NonRetriableError"](`Workflow not found: ${workflowId}`);
        }
        ...
        return {
            ...
            sortedNodes: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["topologicalSort"])(workflow.nodes, workflow.connections)
        };
    });
    ...
    const ownerId = await step.run("find-user-id", async ()=>{
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findUniqueOrThrow({
            where: {
    ...
    for (const node of sortedNodes){
        ...
        try {
            const executor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$executions$2f$components$2f$lib$2f$executor$2d$registry$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getExecutor"])(node.type);
...
const { GET, POST, PUT } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$next$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["serve"])({
    ...
    functions: [
        /* your functions will be passed here later! */ __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$inngest$2f$functions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeWorkflow"]
    ]
});
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__d721af36._.js.map